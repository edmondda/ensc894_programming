...
void drawPuma(GLUquadric *quadric) {
    ...
    float arm_rad = 0.15;
          ...
          glTranslatef(-arm_rad, 0.0f, 0.0f); //link offset
          // VAR!!
          ...
          //move to the start of next arm
          glTranslatef(arm_rad, 0.0f, arm_len);
          ...
          // VAR !!
          //How do we rotate about in-between point?
          //
          ...
          glPushMatrix();
            ...
            glTranslatef(0.0f,0.0f,arm_len/2);
            gluSphere(quadric, arm_rad, 20, 20);

          glPopMatrix();


          glTranslatef(0.0f,0.0f, arm_len/2 - (0.4 + arm_rad) );
          //VAR !!
...
main(int argc, char **argv)
{
  ...
  (new GLUI_Spinner( glui, "Angle 0:", &angle0 ))
    ->set_int_limits( -180, 180);
  (new GLUI_Spinner( glui, "Angle 1:", &angle1 ))
    ->set_int_limits( -180, 180);
  (new GLUI_Spinner( glui, "Angle 2:", &angle2 ))
    ->set_int_limits( -180, 180);
